...
package net.mcreator.darkium.world.structure;
...
public class SkbosshomeStructure extends DarkiumModElements.ModElement {
	public SkbosshomeStructure(DarkiumModElements instance) {
		super(instance, 94);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("darkium", "skygodaltar"));
						if (template == null)
							return false;
