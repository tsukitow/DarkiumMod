...
public class DarkLeavesBlockDestroyedByPlayerProcedure extends DarkiumModElements.ModElement {
	public DarkLeavesBlockDestroyedByPlayerProcedure(DarkiumModElements instance) {
		super(instance, 108);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((Math.random() < 0.2)) {
			if (world instanceof World && !world.getWorld().isRemote) {
				ItemEntity entityToSpawn = new ItemEntity(world.getWorld(), x, y, z, new ItemStack(DarkDustItem.block, (int) (1)));
