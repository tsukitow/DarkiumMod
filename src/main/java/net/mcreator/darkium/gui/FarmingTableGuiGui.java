...
public class FarmingTableGuiGui extends DarkiumModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public FarmingTableGuiGui(DarkiumModElements instance) {
		super(instance, 89);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("farmingtablegui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("darkium:textures/farmingtablegui.png");
		@Override
