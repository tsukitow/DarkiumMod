...
public class DarkiumOreBlock extends DarkiumModElements.ModElement {
	@ObjectHolder("darkium:darkiumore")
	public static final Block block = null;
	public DarkiumOreBlock(DarkiumModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1f, 11.5f).lightValue(2).harvestLevel(2)
					.harvestTool(ToolType.PICKAXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("darkiumore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("darkiumore", "darkiumore", blockAt -> {
			...
			}), block.getDefaultState(), 4), Placement.COUNT_RANGE, new CountRangeConfig(1, 8, 8, 15)));
		}
	}
}
