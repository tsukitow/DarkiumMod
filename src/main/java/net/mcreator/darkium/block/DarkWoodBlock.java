...
import net.mcreator.darkium.procedures.DarkWoodOnBlockRightClickedProcedure;
...
public class DarkWoodBlock extends DarkiumModElements.ModElement {
	@ObjectHolder("darkium:darkwood")
	public static final Block block = null;
	public DarkWoodBlock(DarkiumModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(4f, 10f).lightValue(0));
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				DarkWoodOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
	}
