...
public class DarkBiome2LogBlock extends DarkiumModElements.ModElement {
	@ObjectHolder("darkium:dargroly_log")
	public static final Block block = null;
	public DarkBiome2LogBlock(DarkiumModElements instance) {
		super(instance, 102);
	}
