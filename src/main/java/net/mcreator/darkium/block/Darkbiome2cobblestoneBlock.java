...
public class Darkbiome2cobblestoneBlock extends DarkiumModElements.ModElement {
	@ObjectHolder("darkium:darkgroly_cobblestone")
	public static final Block block = null;
	public Darkbiome2cobblestoneBlock(DarkiumModElements instance) {
		super(instance, 106);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkgroly_cobblestone");
		}
