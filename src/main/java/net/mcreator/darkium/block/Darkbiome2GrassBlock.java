...
public class Darkbiome2GrassBlock extends DarkiumModElements.ModElement {
	@ObjectHolder("darkium:darkgroly_grass")
	public static final Block block = null;
	public Darkbiome2GrassBlock(DarkiumModElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkgroly_grass");
		}
