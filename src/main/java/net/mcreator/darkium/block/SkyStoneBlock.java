...
public class SkyStoneBlock extends DarkiumModElements.ModElement {
	@ObjectHolder("darkium:skystone")
	public static final Block block = null;
	public SkyStoneBlock(DarkiumModElements instance) {
		super(instance, 85);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.6500000000000001f, 10f).lightValue(3)
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SkyCobblestoneBlock.block, (int) (1)));
		}
	}
}
