...
public class SkyGrassBlock extends DarkiumModElements.ModElement {
	@ObjectHolder("darkium:skygrass")
	public static final Block block = null;
	public SkyGrassBlock(DarkiumModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(0.6f, 10f).lightValue(0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("skygrass");
		}
